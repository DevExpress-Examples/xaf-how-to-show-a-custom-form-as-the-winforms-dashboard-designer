...
public class ApplicationBuilder : IDesignTimeApplicationFactory {
    public static WinApplication BuildApplication(string connectionString) {
        ...
        builder.UseApplication<DashBoardCustomFormWindowsFormsApplication>();
        builder.Modules
            .AddDashboards(options => {
                options.DashboardDataType = typeof(DevExpress.Persistent.BaseImpl.DashboardData);
                options.DesignerFormStyle = DevExpress.XtraBars.Ribbon.RibbonFormStyle.Ribbon;
            })
            .Add<DashBoardCustomForm.Module.DashBoardCustomFormModule>()
        	.Add<DashBoardCustomFormWinModule>();
