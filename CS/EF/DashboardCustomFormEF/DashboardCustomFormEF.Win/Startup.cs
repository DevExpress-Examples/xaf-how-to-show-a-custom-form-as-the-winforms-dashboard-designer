...
public class ApplicationBuilder : IDesignTimeApplicationFactory {
    public static WinApplication BuildApplication(string connectionString) {
        ...
        builder.UseApplication<DashboardCustomFormEFWindowsFormsApplication>();
        builder.Modules
            ...
            .Add<DashboardCustomFormEF.Module.DashboardCustomFormEFModule>()
        	.Add<DashboardCustomFormEFWinModule>();
        builder.ObjectSpaceProviders
            .AddEFCore(options => options.PreFetchReferenceProperties())
                .WithDbContext<DashboardCustomFormEF.Module.BusinessObjects.DashboardCustomFormEFEFCoreDbContext>((application, options) => {
