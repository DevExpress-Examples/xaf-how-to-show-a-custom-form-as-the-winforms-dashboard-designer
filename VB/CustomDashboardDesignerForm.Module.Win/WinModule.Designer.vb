Namespace CustomDashboardDesignerForm.[Module].Win
    ...
    Partial Class CustomDashboardDesignerFormWindowsFormsModule
...
'#Region "Component Designer generated code"
        ...
        Private Sub InitializeComponent()
            ' 
            ' CustomDashboardDesignerFormWindowsFormsModule
            ' 
            Me.RequiredModuleTypes.Add(GetType(CustomDashboardDesignerForm.[Module].CustomDashboardDesignerFormModule))
