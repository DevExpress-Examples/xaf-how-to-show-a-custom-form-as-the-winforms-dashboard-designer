...
Namespace CustomDashboardDesignerForm.Win
    ...
    Public Partial Class CustomDashboardDesignerFormWindowsFormsApplication
        ...
        Private Sub CustomDashboardDesignerFormWindowsFormsApplication_CustomizeLanguagesList(ByVal sender As Object, ByVal e As CustomizeLanguagesListEventArgs)
        ...
        Private Sub CustomDashboardDesignerFormWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DatabaseVersionMismatchEventArgs)
#If EASYTEST
            e.Updater.Update();
            e.Handled = true;
#Else
